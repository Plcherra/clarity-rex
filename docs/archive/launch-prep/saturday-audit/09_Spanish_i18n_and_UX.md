...
- **Estimated effort:** Small
- **Brief fix suggestion:** Marketing + App Store / site copy: web companion; mobile primary; fix stale Plaid web string (file 06). Visual/landing polish and `/app/` companion UX live in file 02 Phases D–E — keep claims aligned.
