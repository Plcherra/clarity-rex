...
| **UI polish (02)** | Ship Phase A (Goals-out-of-Knows + shared density) when feasible after 01; Android/iOS/web tracks when claiming those surfaces; not a blocker for truth/security |
...
7. **02** Phase A1 (Goals out of Knows) when bandwidth allows; B/C/D/E only if those platforms are in the launch claim
