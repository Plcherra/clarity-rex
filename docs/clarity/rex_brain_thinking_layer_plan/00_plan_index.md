...
- `00.09` / File 08 is complete: metadata-only Rex Brain observations, local golden route evals including future-level routes, chat observation hooks, and release-gate docs are in place.
...
- `00.11` / File 10 is complete through the future-level exit gate: research opt-in, scenario simulation, proactive insight gating, daily focus, planning workspace, self-evaluation, response style profiles, long-term review, confirmed action preview, and release blockers are documented and wired as preview-safe routing contracts.
- `00.12` / File 11 is complete: voice scoring guard, File 10 exit gate, pending-action contract, future-level evals, and status cleanup are in place.
- Current cursor: release validation and phone testing.
...
5. `05_chat_voice_integration.md` - chat and voice integration behind Rex Brain routing flags.
...
10. `10_future_levels.md` - research mode, simulations, proactive intelligence, daily focus, planning workspace, self-evaluation, style profiles, long-term review, confirmed action preview, and exit gates.
11. `11_plan_hardening_followup.md` - follow-up fixes for voice latency, exit gates, pending-action safety, future-level evals, and stale plan wording.
