...
1. Verify voice walking flow end-to-end in `apps/mobile/lib/rex/voice`, `apps/mobile/lib/rex/chat`, and `services/rex-api/app/services/chat_service.py`.
2. Harden Reliable Delete in `services/rex-api/app/services/memory_turn_service.py`, `services/rex-api/app/services/memory_turn_direct_helpers.py`, and the Knows UI delete path under `apps/mobile/lib/rex`.
