...
MEMORY_DISCIPLINE_PROMPT = (
    ...
    "confirmed facts. Old chat evidence is only evidence from past conversation; if "
    "that is the only signal, say you found an old chat mention instead of saying "
    "Clarity knows it or has it saved. For important, risky, destructive, or "
...
LONG_TERM_MEMORY_PREFIX = "Relevant saved memory and old chat evidence:\n"
