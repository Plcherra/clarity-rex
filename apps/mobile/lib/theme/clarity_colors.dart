...
class ClarityColors {
  ...
  static const dark = ClarityColorTokens(
    ...
    surfaceElevated: Color(0xFF151618),
    surfaceSoft: Color(0xFF202226),
    cardFill: Color(0xF20B0B0C),
    accent: Color(0xFF00D6C0),
    accentSoft: Color(0x3317D7C4),
    accentStrong: Color(0xFF66F4E5),
    textPrimary: Color(0xFFF7F7F7),
    textSecondary: Color(0xFFB3B6BC),
    textMuted: Color(0xFF7F858E),
    border: Color(0x123A3F46),
    borderActive: Color(0x7A17D7C4),
    divider: Color(0x128A9099),
    danger: Color(0xFFFF6B6B),
    warning: Color(0xFFFBBF24),
    financePositive: Color(0xFF2EE59D),
    financeNegative: Color(0xFFFF6B6B),
    financeSpending: Color(0xFFFF5C6C),
  );

  static const light = ClarityColorTokens(
    background: Color(0xFFF7F9FB),
    surface: Color(0xFFFFFFFF),
    surfaceElevated: Color(0xFFF2F5F8),
    surfaceSoft: Color(0xFFE8EEF3),
    cardFill: Color(0xFFFFFFFF),
    accent: Color(0xFF00C8AE),
    accentSoft: Color(0x2E00C8AE),
    accentStrong: Color(0xFF008F7C),
    textPrimary: Color(0xFF111111),
    textSecondary: Color(0xFF4B5563),
    textMuted: Color(0xFF6B7280),
    border: Color(0x1F8792A2),
    borderActive: Color(0x7300A991),
    divider: Color(0x1A9AA4B2),
    danger: Color(0xFFE11D48),
    warning: Color(0xFFD97706),
    financePositive: Color(0xFF059669),
    financeNegative: Color(0xFFE11D48),
