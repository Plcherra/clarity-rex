...
import 'package:clarity/widgets/clarity_text_prompt.dart';
...
Future<void> renameConversationFlow({
  ...
  final nextTitle = await showClarityTextPrompt(
    context,
    title: l10n.conversationListRenameTitle,
    fieldLabel: l10n.conversationListRenameHint,
    initialValue: conversation.title?.trim().isNotEmpty == true
