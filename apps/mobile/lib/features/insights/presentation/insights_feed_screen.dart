  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () => ref.read(insightsProvider.notifier).load(syncFirst: true),
                  ...
                  if (state.items.isEmpty)
                    ...
                    for (final item in state.items) ...[
                      _InsightFeedTile(
                        item: item,
                        onTap: () async {
                          await ref.read(insightsProvider.notifier).markRead(item);
                        },
                        onViewDashboard: item.anchor == null
                            ...
                            : () {
                                ref
                                    .read(
                                      dashboardDeepLinkRequestProvider.notifier,
                                    )
                                    .request(item.anchor!);
